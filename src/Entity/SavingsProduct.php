...
{
    #[ORM\Column(name: 'prime_reccurence', type: Types::STRING, nullable: true)]
    private ?string $primeRecurence = null;
    ...
    public function getPrimeRecurence(): ?string
    {
        return $this->primeRecurence;
    }

    public function setPrimeRecurence(?string $primeRecurence): self
    {
