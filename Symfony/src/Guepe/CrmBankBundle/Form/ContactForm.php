   ...
   public function buildForm(FormBuilder $builder, array $options)
    {        
        $builder
            ...
            ->add('gsm','text',array("label" => "GSM", 'required' => false))
            ->add('birthplace','text',array("label" => "Lieu de naissance", 'required' => false))
            ...
            ->add('income_amount','money',array("label" => "Revenus", 'required' => false))
            ->add('income_recurence','choice',array("label" => "Fréquence des rentrées", 'required' => false, 'choices' =>
            	 array(
            	 'monthly' => 'Mensuel',
            	 'annual' => 'Annuel'
            	 )))
            ->add('income_date','text',array("label" => 'Date des rentrées', 'required' => false))
           // ->add('files')
            ;
    }
