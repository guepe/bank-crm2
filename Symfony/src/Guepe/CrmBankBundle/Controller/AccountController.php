...
/**
	...
	*/
	...
	public function editAction($id=null)
	{
		...
		$form = $this->container->get('form.factory')->create(new AccountForm(), $account);
...
public function listAction()
{
	...
	return $this->container->get('templating')->renderResponse('GuepeCrmBankBundle:Account:search.html.twig', array(
		'accounts' => $accounts,
		'form' => $form->createView()
	));
}
...
{               
    ...
    if($request->isXmlHttpRequest())
    {
        ...
        if($motcle != '')
        {
               ...
               $qb->select('a')
                  ->from('GuepeCrmBankBundle:Account', 'a')
